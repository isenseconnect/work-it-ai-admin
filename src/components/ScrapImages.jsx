...
import { apiCall, screenshotApiCall, uploadFileAPICall } from "../helper/apiHelper";
...
const ScrapImages = () => {
  ...
  const getAllTools = async () => {
    const response = await apiCall("tools/getAll", "GET")
  ...
  return (
    <div>
      ...
      <button onClick={getAllTools}>Display Tools</button>
